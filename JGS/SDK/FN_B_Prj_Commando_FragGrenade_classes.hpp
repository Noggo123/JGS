...
public:
	...
	bool                                               bHasClusterTactical;                                      // 0x0A68(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x7];                                       // 0x0A69(0x0007) MISSED OFFSET
	struct FFortGameplayEffectContainerSpec            Cluster_Tactical_Container_Spec;                          // 0x0A70(0x0080) (Edit, BlueprintVisible)
