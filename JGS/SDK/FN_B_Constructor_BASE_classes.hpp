...
public:
	...
	unsigned char                                      UnknownData11[0x7];                                       // 0x1701(0x0007) MISSED OFFSET
	class UClass*                                      GE_Enduring_Machine;                                      // 0x1708(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FGameplayTagContainer                       TC_Enduring_Machine;                                      // 0x1710(0x0020) (Edit, BlueprintVisible, DisableEditOnInstance)
