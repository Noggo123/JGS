...
struct AFortnitePartyHeroSelect_Camera_C_InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_7_8_Params
{
...
struct AFortnitePartyHeroSelect_Camera_C_InpActEvt_LeftMouseButton_K2Node_InputKeyEvent_6_7_Params
{
	struct FKey                                        Key;                                                      // (Parm)
};
...
struct AFortnitePartyHeroSelect_Camera_C_InpActEvt_RightMouseButton_K2Node_InputKeyEvent_5_6_Params
{
	struct FKey                                        Key;                                                      // (Parm)
};
...
struct AFortnitePartyHeroSelect_Camera_C_InpActEvt_RightMouseButton_K2Node_InputKeyEvent_4_5_Params
{
	struct FKey                                        Key;                                                      // (Parm)
};
