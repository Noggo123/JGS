...
public:
	...
	TEnumAsByte<ETimelineDirection>                    DiveTrailUpdate__Direction_B66364034F77F774B1B73FA0DCEE7236;// 0x0448(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0449(0x0007) MISSED OFFSET
	class UTimelineComponent*                          DiveTrailUpdate;                                          // 0x0450(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
