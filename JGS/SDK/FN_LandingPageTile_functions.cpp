...
{
	static auto fn = UObject::FindObject<UFunction>("Function LandingPageTile.LandingPageTile_C.OnHovered");

	ULandingPageTile_C_OnHovered_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function LandingPageTile.LandingPageTile_C.OnUnhovered");

	ULandingPageTile_C_OnUnhovered_Params params;
