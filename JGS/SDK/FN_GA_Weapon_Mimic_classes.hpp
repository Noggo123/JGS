...
public:
	...
	float                                              Default_Duration;                                         // 0x0AC8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              Pulse_Duration;                                           // 0x0ACC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FGameplayEventData                          EventData;                                                // 0x0AD0(0x00A8) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	struct FGameplayTagContainer                       TC_AutomatedDefenses;                                     // 0x0B80(0x0020) (Edit, BlueprintVisible, DisableEditOnInstance)
	class UClass*                                      B_Prj_Mimic_Chest;                                        // 0x0BA0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              Prj_BR_HolderSpeed;                                       // 0x0BA8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              Prj_BR_Holder_Gravity;                                    // 0x0BAC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	struct FGameplayTag                                EC_BottleRocket_Explode;                                  // 0x0BC0(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	class UAnimMontage*                                M_ThrowDown;                                              // 0x0BC8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IFFCoding;                                                // 0x0BD0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0BD1(0x0003) MISSED OFFSET
	float                                              LifeTime;                                                 // 0x0BD4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FGameplayTag                                EC_BottleRocketHolder_Explode;                            // 0x0BD8(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayEffectContextHandle                NewVar;                                                   // 0x0BE0(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	class UParticleSystem*                             P_MuzzleFlash;                                            // 0x0BF8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FGameplayTag                                GC_Muzzle;                                                // 0x0C00(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayEffectContextHandle                NewVar0;                                                  // 0x0C08(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayCueParameters                      NewVar1;                                                  // 0x0C20(0x00B8) (Edit, BlueprintVisible, DisableEditOnInstance)
