...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaMatchmakingOptionsDisplay_v2.AthenaMatchmakingOptionsDisplay_v2_C.OnBack");

	UAthenaMatchmakingOptionsDisplay_v2_C_OnBack_Params params;
...
// bool*                          PlaylistIsTeam                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
void UAthenaMatchmakingOptionsDisplay_v2_C::UpdateMatchmakingButtonsBP(bool* IsPartyLeader, bool* IsMatchmaking, bool* PlaylistSupportsPartySize, bool* PlaylistIsTeam)
{
	...
	params.PlaylistIsTeam = PlaylistIsTeam;
