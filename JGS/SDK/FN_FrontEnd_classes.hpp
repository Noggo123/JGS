...
public:
	...
	bool                                               IsRandomCustomization;                                    // 0x04FC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	class AFrontendCamera_Manage_C*                    FrontendCamera_StoreItemInspect_EdGraph_2_RefProperty;    // 0x0528(0x0008) (ZeroConstructor, IsPlainOldData)
	class AFrontendCamera_Manage_C*                    FrontendCamera_Cosmetics_EdGraph_2_RefProperty;           // 0x0530(0x0008) (ZeroConstructor, IsPlainOldData)
	class AFrontendCamera_Manage_C*                    FrontendCamera_SmallCosmetics_EdGraph_2_RefProperty;      // 0x0538(0x0008) (ZeroConstructor, IsPlainOldData)
