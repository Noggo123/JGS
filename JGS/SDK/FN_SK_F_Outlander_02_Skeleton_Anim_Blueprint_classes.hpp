...
public:
	...
	struct FAnimNode_AnimDynamics                      AnimGraphNode_AnimDynamics_10AE448948DFDAC48D633A9115DE9546;// 0x08B0(0x0380)
	struct FAnimNode_ConvertComponentToLocalSpace      AnimGraphNode_ComponentToLocalSpace_C2C423994AF0E2ACB767DBB2F2A9F807;// 0x0C30(0x0048)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0C78(0x0008) MISSED OFFSET
	struct FAnimNode_AnimDynamics                      AnimGraphNode_AnimDynamics_CD200A494CE2706612624D82C982B3A9;// 0x0C80(0x0380)
	struct FAnimNode_AnimDynamics                      AnimGraphNode_AnimDynamics_EC6023534626A7FAFE689C8E45E86E07;// 0x1000(0x0380)
	struct FAnimNode_AnimDynamics                      AnimGraphNode_AnimDynamics_EA3B9A5B407C0B0134CDBEBE3E9A5A96;// 0x1380(0x0380)
	struct FAnimNode_AnimDynamics                      AnimGraphNode_AnimDynamics_FEDD4DD14777B86ABE0537A59A5135CD;// 0x1700(0x0380)
	struct FAnimNode_BoneDrivenController              AnimGraphNode_BoneDrivenController_C5D99D0F44097D61E3DBD9A455D468EA;// 0x1A80(0x0190)
	struct FAnimNode_BoneDrivenController              AnimGraphNode_BoneDrivenController_1D18CAEC448657ED9FCA44951F18E351;// 0x1C10(0x0190)
	class USkeletalMeshComponent*                      MeshToCopy;                                               // 0x1DA0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
