...
public:
	...
	class UFortWorldItemDefinition*                    C4ItemDef;                                                // 0x0AC8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FGameplayTag                                TrackedActorTag;                                          // 0x0AD0(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	float                                              DelayBetweenExplosions;                                   // 0x0AD8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              CurrentExplosionDelay;                                    // 0x0ADC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
