...
public:
	...
	class UStaticMeshComponent*                        MeshScreenPlane;                                          // 0x08C8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             SceneInitializeFX;                                        // 0x08D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UTimelineComponent*                          FocusTimeline;                                            // 0x08E0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UTimelineComponent*                          DEBUGFOVA;                                                // 0x08F0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UTimelineComponent*                          InitializeFX_TL;                                          // 0x0900(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UTimelineComponent*                          DebugZoomTL;                                              // 0x0930(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	void InpActEvt_MouseScrollUp_K2Node_InputKeyEvent_7_8(const struct FKey& Key);
	void InpActEvt_MouseScrollDown_K2Node_InputKeyEvent_6_7(const struct FKey& Key);
	void InpActEvt_Gamepad_LeftTrigger_K2Node_InputKeyEvent_5_6(const struct FKey& Key);
