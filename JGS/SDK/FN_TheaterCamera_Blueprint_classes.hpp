...
public:
	...
	unsigned char                                      UnknownData12[0x3];                                       // 0x0AB5(0x0003) MISSED OFFSET
	float                                              LastZoomButtonHeldTime;                                   // 0x0AB8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
