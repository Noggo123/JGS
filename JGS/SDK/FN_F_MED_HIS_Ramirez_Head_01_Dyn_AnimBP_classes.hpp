...
public:
	...
	struct FAnimNode_AnimDynamics                      AnimGraphNode_AnimDynamics_18FA112E46ABA0D05274AA95C741D095;// 0x04D0(0x0380)
	...
	struct FAnimNode_AnimDynamics                      AnimGraphNode_AnimDynamics_20B56F374DE380A7E12409AE93F8D7F9;// 0x08E0(0x0380)
	struct FAnimNode_AnimDynamics                      AnimGraphNode_AnimDynamics_8B2A53064649ECCBE2C488A1BFAA1ABC;// 0x0C60(0x0380)
	struct FAnimNode_AnimDynamics                      AnimGraphNode_AnimDynamics_912B846445FBAD349FA22EBCF5DB5505;// 0x0FE0(0x0380)
	struct FAnimNode_SaveCachedPose                    AnimGraphNode_SaveCachedPose_A51E3A934B8D907BC2DA37A7CE8355D3;// 0x1360(0x00E0)
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_E6FD1209434285325183BFB8C8B047D7;// 0x1440(0x0050)
	struct FAnimNode_BlendListByBool                   AnimGraphNode_BlendListByBool_90E87AEB4216ABCCD1A7C288696B4405;// 0x1490(0x00D0)
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_890553D14E92A2709A57D6913EA2991E;// 0x1560(0x0050)
	class USkeletalMeshComponent*                      MeshToCopy;                                               // 0x15B0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
