...
public:
	...
	struct FVector                                     PortalInStartLocation;                                    // 0x0B2C(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     PortalInEndLocation;                                      // 0x0B38(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     PortalOutEndLocation;                                     // 0x0B44(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	class UFortAbilityTask_MoveAI*                     PortalInMove;                                             // 0x0B50(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UFortAbilityTask_MoveAI*                     PortalOutMove;                                            // 0x0B58(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
