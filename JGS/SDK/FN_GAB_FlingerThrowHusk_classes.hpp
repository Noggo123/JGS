...
public:
	...
	class AFlingerPawn_C*                              FlingerPawn;                                              // 0x0AC8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	class AHuskPawn_C*                                 HuskHeldByFlinger;                                        // 0x0AD0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	struct FGameplayTag                                GC_FlingerGrabNPC;                                        // 0x0AD8(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTag                                GC_NPCRangedThrow;                                        // 0x0AE0(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
