...
{
	static auto fn = UObject::FindObject<UFunction>("Function B_BGA_BotTurret_Parent.B_BGA_BotTurret_Parent_C.Fired");

	AB_BGA_BotTurret_Parent_C_Fired_Params params;
