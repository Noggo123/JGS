...
public:
	...
	class AFortPlayerPawnAthena*                       TargetPlayer;                                             // 0x0448(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
