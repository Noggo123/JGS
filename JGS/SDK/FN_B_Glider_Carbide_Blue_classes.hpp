...
public:
	...
	class UParticleSystemComponent*                    Glider_GLOW;                                              // 0x0380(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UParticleSystemComponent*                    TrailParticles2;                                          // 0x0388(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass B_Glider_Carbide_Blue.B_Glider_Carbide_Blue_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_B_Glider_Carbide_Blue(int EntryPoint);
};
