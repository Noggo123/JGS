...
void UAthenaReplayBrowserTab_C::ShowErrorDialog(struct FText* Title, struct FText* MESSAGE)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaReplayBrowserTab.AthenaReplayBrowserTab_C.ShowErrorDialog");

	UAthenaReplayBrowserTab_C_ShowErrorDialog_Params params;
	params.Title = Title;
