...
struct FChatMarkupStyle
{
	...
	struct FTextBlockStyle                             MarkupTextStyle;                                          // 0x0278(0x01E0) (Edit)
	struct FSlateBrush                                 MarkupBackground;                                         // 0x0458(0x0088) (Edit)
	struct FSlateColor                                 ButtonColor;                                              // 0x04E0(0x0028) (Edit)
	struct FSlateColor                                 ButtonHoverColor;                                         // 0x0508(0x0028) (Edit)
	struct FSlateColor                                 TipColor;                                                 // 0x0530(0x0028) (Edit)
	struct FSlateBrush                                 SeperatorBrush;                                           // 0x0558(0x0088) (Edit)
	float                                              SeperatorThickness;                                       // 0x05E0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FMargin                                     MarkupPadding;                                            // 0x05E4(0x0010) (Edit, IsPlainOldData)
	struct FMargin                                     ButtonPadding;                                            // 0x05F4(0x0010) (Edit, IsPlainOldData)
...
struct FChatStyle
{
	...
	struct FMargin                                     ChatEntryPadding;                                         // 0x1290(0x0010) (Edit, IsPlainOldData)
	...
	struct FMargin                                     FriendActionPadding;                                      // 0x1330(0x0010) (Edit, IsPlainOldData)
	struct FMargin                                     FriendActionHeaderPadding;                                // 0x1340(0x0010) (Edit, IsPlainOldData)
	struct FMargin                                     FriendActionStatusMargin;                                 // 0x1350(0x0010) (Edit, IsPlainOldData)
};
...
struct FSocialFontStyle
{
	...
	struct FLinearColor                                DefaultFontColor;                                         // 0x01E0(0x0010) (Edit, IsPlainOldData)
	struct FLinearColor                                InvertedFontColor;                                        // 0x01F0(0x0010) (Edit, IsPlainOldData)
	struct FLinearColor                                DefaultDullFontColor;                                     // 0x0200(0x0010) (Edit, IsPlainOldData)
};
...
struct FSocialStyle
{
	...
	struct FChatMarkupStyle                            ChatMarkupStyle;                                          // 0x6080(0x0608) (Edit)
	struct FSocialSoundSchema                          SoundSchema;                                              // 0x6688(0x0048) (Edit)
};
