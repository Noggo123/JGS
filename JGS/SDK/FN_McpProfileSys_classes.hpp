...
public:
	...
	bool                                               bIsProcessingRequestGenerator;                            // 0x01D8(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x7];                                       // 0x01D9(0x0007) MISSED OFFSET
	struct FString                                     LockCode;                                                 // 0x01E0(0x0010) (ZeroConstructor)
	TArray<class UMcpProfile*>                         LockedProfiles;                                           // 0x01F0(0x0010) (ZeroConstructor)
	struct FString                                     LockedProfilesString;                                     // 0x0200(0x0010) (ZeroConstructor)
	int                                                ProfileWriteLockTimeoutSecs;                              // 0x0210(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bSubscribedToNotifications;                               // 0x0214(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x0215(0x0003) MISSED OFFSET
	struct FString                                     ApplyStashEndPoint;                                       // 0x0218(0x0010) (ZeroConstructor, Config)
	bool                                               bPendingInterceptedRequest;                               // 0x0228(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0xF];                                       // 0x0229(0x000F) MISSED OFFSET
	bool                                               bSendProfileCommandRevisions;                             // 0x0238(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData07[0x87];                                      // 0x0239(0x0087) MISSED OFFSET
