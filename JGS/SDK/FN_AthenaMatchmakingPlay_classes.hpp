...
public:
	...
	struct FScriptMulticastDelegate                    PlaylistsUpdated;                                         // 0x02E0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
