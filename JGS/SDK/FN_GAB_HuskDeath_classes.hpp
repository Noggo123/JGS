...
{
public:
	struct FGameplayTag                                LaserTag;                                                 // 0x0C50(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	class UAnimMontage*                                Headshot;                                                 // 0x0C58(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
