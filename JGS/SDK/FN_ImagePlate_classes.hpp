...
{
public:
	class UImagePlateComponent*                        ImagePlate;                                               // 0x0318(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
{
public:
	struct FImagePlateParameters                       Plate;                                                    // 0x0640(0x0038) (Edit)
...
{
public:
	class UImagePlateFileSequence*                     FileSequence;                                             // 0x0110(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bReuseExistingTexture;                                    // 0x0118(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
