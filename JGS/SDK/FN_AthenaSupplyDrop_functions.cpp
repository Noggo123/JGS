...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaSupplyDrop.AthenaSupplyDrop_C.Landed");

	AAthenaSupplyDrop_C_Landed_Params params;
...
void AAthenaSupplyDrop_C::Rotate()
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaSupplyDrop.AthenaSupplyDrop_C.Rotate");

	AAthenaSupplyDrop_C_Rotate_Params params;
