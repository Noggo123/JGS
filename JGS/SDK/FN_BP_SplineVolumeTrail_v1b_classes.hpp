...
public:
	...
	class USkeletalMeshComponent*                      Skeletal_Mesh;                                            // 0x0348(0x0008) (Edit, BlueprintVisible, Net, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FName                                       Socket_Attach_Point;                                      // 0x0350(0x0008) (Edit, BlueprintVisible, Net, ZeroConstructor, IsPlainOldData)
	...
	void GetSocketLocationWS(const struct FName& Socket_Name, struct FVector* LocationWS, bool* Skeletal_Mesh_InValid, bool* Socket_Invalid);
