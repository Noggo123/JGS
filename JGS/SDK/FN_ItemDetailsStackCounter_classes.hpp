...
public:
	...
	struct FFortMultiSizeMargin                        MultiSizeMargin;                                          // 0x0788(0x0060) (Edit, BlueprintVisible)
	TEnumAsByte<EFortBrushSize>                        Brush_Size;                                               // 0x07E8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x07E9(0x0003) MISSED OFFSET
	int                                                Count;                                                    // 0x07EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               AlwaysVisible;                                            // 0x07F0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               TruncateValue;                                            // 0x07F1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
