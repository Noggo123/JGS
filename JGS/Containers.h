...
namespace Containers
{
	...
	static auto Malloc = reinterpret_cast<void* (*)(int32 Size, int32 Alignment)>(uintptr_t(GetModuleHandle(0)) + 0x13076F0);
	static auto Realloc = reinterpret_cast<void* (*)(void* Memory, int64 NewSize, uint32 Alignment)>(uintptr_t(GetModuleHandle(0)) + 0x13095F0);
	static auto Free = reinterpret_cast<void (*)(void* Memory)>(uintptr_t(GetModuleHandle(0)) + 0x12FC6E0);
	...
	public:
		...
		FORCEINLINE void Reset(int MinSizeAfterReset = 0)
		{
			...
			Free(Data);
			Data = (TArrayType*)Malloc(MinSizeAfterReset * sizeof(TArrayType), alignof(TArrayType));
		}
